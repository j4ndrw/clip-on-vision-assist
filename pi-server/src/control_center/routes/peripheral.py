...
from src.control_center.models.peripheral.endpoint.amend_microphone_config import AmendMicrophoneConfigurationRequest
from src.control_center.models.peripheral.endpoint.get_current_camera_configuration import GetCurrentCameraConfigurationResponse
from src.control_center.models.peripheral.endpoint.get_current_microphone_configuration import GetCurrentMicrophoneConfigurationResponse
from src.control_center.models.peripheral.endpoint.amend_camera_config import AmendCameraConfigurationRequest
from src.control_center.services.peripheral.get_current_camera_configuration import get_current_camera_configuration
from src.control_center.services.peripheral.get_current_microphone_configuration import get_current_microphone_configuration
from src.control_center.services.peripheral.amend_camera_configuration import amend_camera_configuration
from src.control_center.services.peripheral.amend_microphone_configuration import amend_microphone_configuration
...
def get_current_microphone_configuration_route():
    ...
    return GetCurrentMicrophoneConfigurationResponse(microphone_config=microphone_config).as_json()
